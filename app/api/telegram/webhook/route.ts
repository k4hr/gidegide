...
async function handleMessage(message: NonNullable<TelegramUpdate["message"]>) {
  ...
  if (command === "/start") return sendTelegramMessage(chatId, "🎬 Завод готов. Пришли VK/VKVideo ссылку на фильм.", menu());
  if (command === "/help") return sendTelegramMessage(chatId, "Пришли ссылку vkvideo.ru или vk.com на фильм. Я предложу быстрый запуск или настройки.\n\n/status — последние задачи\n/queue — очередь публикаций\n/help — эта справка");
