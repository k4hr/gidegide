...
const bodySchema = z.object({
  ...
  storyMinSeconds: z.coerce.number().int().min(10).max(55).default(15),
  storyMaxSeconds: z.coerce.number().int().min(10).max(60).default(25),
  ...
  windowStartHour: z.coerce.number().int().min(0).max(23).default(15),
  windowStartMinute: z.coerce.number().int().min(0).max(59).default(0),
  windowEndHour: z.coerce.number().int().min(0).max(23).default(19),
  windowEndMinute: z.coerce.number().int().min(0).max(59).default(0),
      ...
      const job = await withDbRetry(() =>
        prisma.factoryJob.create({
          data: {
            ...
            smartStepSeconds: 5,
            smartCandidates: 90,
            smartMinGapSeconds: Math.max(24, body.storyMaxSeconds),
